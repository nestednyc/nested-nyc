...
export const DEMO_USER_PROFILE = {
  ...
  // Public tech stack (displayed on profile)
  publicTechStack: ['react', 'typescript', 'nodejs', 'python', 'supabase', 'vercel', 'figma', 'postgresql'],
...
export const MOCK_USER_PROFILES = {
  'req-1': {
    ...
    publicTechStack: ['react', 'python', 'typescript', 'nodejs', 'docker', 'aws', 'aiml'],
  ...
  'req-2': {
    ...
    publicTechStack: ['figma', 'react', 'uiux', 'javascript'],
