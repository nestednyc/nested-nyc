 ...
 * - Primary CTA: Create account → navigates to email/password sign-up
 * - Secondary: Sign in link for existing users
 * - Social links (for future connection, not auth)
 */
...
function InstagramIcon() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="#5B4AE6">
