...
import { getDiscoverProjects, getSavedProjects } from '../utils/projectData'
...
// Recently active mock data
const RECENTLY_ACTIVE = [
  { id: 'ra-1', title: 'ClimateTech Dashboard', lastActivity: '2 hours ago', avatar: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&h=100&fit=crop' },
  { id: 'ra-2', title: 'AI Study Buddy', lastActivity: '5 hours ago', avatar: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&h=100&fit=crop' },
  { id: 'ra-3', title: 'NYC Transit Tracker', lastActivity: 'Yesterday', avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=100&h=100&fit=crop' },
]
...
function DiscoverScreen() {
  ...
  // Load projects, nests, saved projects, and events from centralized store
  useEffect(() => {
      ...
      {(activeTab === 'projects' || !SHOW_NESTS) ? (
        ...
        >
          ...
          >
            ...
            {/* Right Column - Sidebar Sections (reduced visual weight) */}
            <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
              ...
              >
                <h3 style={{ margin: 0, marginBottom: '14px', fontSize: '13px', fontWeight: 600, color: '#6B7280', textTransform: 'uppercase', letterSpacing: '0.04em' }}>
                  Recently Active
                </h3>
                <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                  {RECENTLY_ACTIVE.map(item => (
                    <div 
                      key={item.id}
                      style={{
                        display: 'flex',
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <p style={{ margin: '3px 0 0 0', fontSize: '11px', color: '#5B4AE6', fontWeight: 500 }}>
                          {event.date} • {event.time?.split(' - ')[0] || event.time}
                        </p>
                        <p style={{ margin: '1px 0 0 0', fontSize: '10px', color: '#9CA3AF' }}>
                          {event.location}
                        </p>
