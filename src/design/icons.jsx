...
// category + ui icon path data
  const ICONS = {
    ...
    brand: `<path d="M12.8 3.2H5.4A2.2 2.2 0 0 0 3.2 5.4v7.4l8.5 8.5a2.2 2.2 0 0 0 3.1 0l6.5-6.5a2.2 2.2 0 0 0 0-3.1L12.8 3.2Z"/><circle cx="8.3" cy="8.3" r="1.6"/><path d="M8.3 6.7C8.3 4.6 10 3.2 12.2 3.2"/>`,
    film: `<path d="M20.6 5.2 3.4 10.3l-.7-2.2a2 2 0 0 1 1.4-2.5L17 1.7a2 2 0 0 1 2.5 1.3Z"/><path d="m7.1 4.7 2.8 3.5M12.6 3.1l2.8 3.5"/><path d="M3.4 10.3h17.2v8.5a2 2 0 0 1-2 2H5.4a2 2 0 0 1-2-2Z"/>`,
