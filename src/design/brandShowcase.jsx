...
import { LinkedNestsMark, JoinedRingsMark, ThreadedNestMark, Lockup, INK } from './logoConcepts'

/**
 * BrandShowcase - Internal logo concept gallery at /brand
 *
 * Recovered from the pre-refactor era (git aca3d96) and ported into the
 * current shell architecture. Standalone full page — brings its own
 * background and typography, deliberately outside the cork-board tokens:
 * the marks have to be judged on neutral ground.
 *
...
const BORDER = '#E5E7EB'
const PAGE_FONT = "'Inter', 'Hanken Grotesk', sans-serif"
...
function BrandShowcase() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#FAFAFA', fontFamily: PAGE_FONT }}>
...
/** Replica of a light navbar for in-context testing */
