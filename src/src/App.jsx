  ...
  return (
    <Routes>
      ...
      <Route path="/my-profile" element={
        isDesktop 
          ? <WebLayout layoutType="app"><MyProfileScreen /></WebLayout>
          : <MobileFrame><MyProfileScreen /></MobileFrame>
      } />
      ...
      {/* Nest Detail */}
      <Route path="/nests/:nestId" element={
        isDesktop 
          ? <WebLayout layoutType="app"><NestDetailScreen /></WebLayout>
          : <MobileFrame><NestDetailScreen /></MobileFrame>
      } />
      
      {/* Create Nest */}
      <Route path="/create-nest" element={
        isDesktop 
          ? <WebLayout layoutType="form"><CreateNestScreen /></WebLayout>
          : <MobileFrame><CreateNestScreen /></MobileFrame>
      } />
